...
public class ConnectionConfigurator extends ServerEndpointConfig.Configurator {
    ...
    public <T> T getEndpointInstance(Class<T> clazz) throws InstantiationException {
        Connection chatConnection = (Connection) super.getEndpointInstance(clazz);
        ...
        chatConnection.setChatConnectionManager(SpringUtils.getBean(ConnectionManager.class));
