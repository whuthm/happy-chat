...
class ConversationManager extends AbstractChatContextImplService
    ...
    public Observable<Conversation> getConversation(final String conversationId) {
        return Observable.create(new ObservableOnSubscribe<Conversation>() {
            @Override
    ...
    public Observable<List<Conversation>> getAllConversations() {
        return Observable.create(new ObservableOnSubscribe<List<Conversation>>() {
            @Override
